    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="medical" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6>PHARMACY</h6></a>
          </li>
        </ul>
      </div>
    </div>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="download (1).jfif"  width="100" height="50" alt=""/>
                        <h3>Welcome</h3>
